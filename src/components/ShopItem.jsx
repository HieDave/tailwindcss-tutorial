...
const ShopItem = ({props}) => {
  ...
  return (
    <div className='relative p-6 bg-white rounded-lg'>
        <button className='absolute top-3 right-3 text-gray-400 rounded-full p-2 hover:bg-pink-300 hover:bg-opacity-50 hover:text-primary hover:transition duration-500 active:bg-pink-700'>
